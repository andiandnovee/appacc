        ...
        <Card class="max-w-2xl">
            <form @submit.prevent="handleSaveSettings" class="space-y-6">
                <div>
                    ...
                    <TextInput v-model="formData.app_name" id="app_name" placeholder="My App" class="mt-1" />
                </div>

                <div>
                    <Label for="app_url" value="Application URL" />
                    <TextInput v-model="formData.app_url" id="app_url" type="url" placeholder="https://example.com"
                        class="mt-1" />
                </div>

                <div>
                    <Label for="timezone" value="Timezone" />
                    <Select v-model="formData.timezone" id="timezone" class="mt-1">
                ...
                <div class="flex items-center gap-3 py-3">
                    <Checkbox v-model="formData.maintenance_mode" id="maintenance" />
                    <Label for="maintenance" value="Maintenance Mode" />
                    <p class="text-xs text-gray-500">disable access to the application for regular users</p>
                </div>

                <div class="flex gap-3 pt-4 border-t border-gray-200">
                    <Button type="submit" :disabled="formLoading" color="blue" class="flex-1 max-w-xs">
...
import { Card, Label, TextInput, Select, Checkbox, Button } from 'flowbite-vue'
app_url: '',
    timezone: 'UTC',
