...
CREATE TABLE `account_balances` (
  ...
  KEY `account_balances_company_code_index` (`company_code`),
...
CREATE TABLE `accounts` (
  ...
  KEY `accounts_company_code_index` (`company_code`)
...
CREATE TABLE `journal_entries` (
  ...
  KEY `journal_entries_company_code_index` (`company_code`),
...
-- Dump completed on 2025-10-09  0:44:30
