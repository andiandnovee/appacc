    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'indonesia' => \Laravolt\Indonesia\IndonesiaService::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./var/www/html/bskmApi/public/storage' => 'string',
            'laravolt.indonesia.table_prefix' => 'string',
            'laravolt.indonesia.route.enabled' => 'boolean',
            'laravolt.indonesia.route.middleware' => 'array',
            'laravolt.indonesia.route.prefix' => 'string',
            'laravolt.indonesia.view.layout' => 'string',
            'laravolt.indonesia.menu.enabled' => 'boolean',
...
'auth.guards.api.driver','auth.guards.api.provider','auth.guards.api.hash','auth.providers.users.driver','auth.providers.users.model',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/html/bskmApi/public/storage',
'laravolt.indonesia.table_prefix','laravolt.indonesia.route.enabled','laravolt.indonesia.route.middleware','laravolt.indonesia.route.prefix','laravolt.indonesia.view.layout',
'laravolt.indonesia.menu.enabled','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','passport.guard','passport.private_key',
'passport.public_key','passport.connection','permission.models.permission','permission.models.role','permission.table_names.roles',
...
'services.google.client_id','services.google.client_secret','services.google.redirect','session.driver','session.lifetime',
...
'concurrency.default','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'passport.authorizations.approve','passport.authorizations.deny','passport.device.authorizations.authorize','passport.device.authorizations.approve','passport.device.authorizations.deny','api.me','ref-iuran.index','ref-iuran.show','ref-iuran.store',
'ref-iuran.update','ref-iuran.destroy','anggotas.index','anggotas.show',
'anggotas.store','anggotas.update','anggotas.destroy','user-anggota-request.store','user-anggota-request.status',
'anggota-requests.index','anggota-requests.approve','anggota-requests.reject','storage.local',);
        registerArgumentsSet('views', 
'indonesia::kabupaten.create','indonesia::kabupaten.edit','indonesia::kabupaten.index','indonesia::kecamatan.create','indonesia::kecamatan.edit',
'indonesia::kecamatan.index','indonesia::kelurahan.create','indonesia::kelurahan.edit','indonesia::kelurahan.index','indonesia::provinsi.create',
'indonesia::provinsi.edit','indonesia::provinsi.index','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'SESSION_DOMAIN','SESSION_DRIVER','SESSION_SECURE_COOKIE','FRONTEND_URL','APP_LOCALE',
'APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER','PHP_CLI_SERVER_WORKERS','BCRYPT_ROUNDS',
'LOG_CHANNEL','LOG_STACK','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','DB_CONNECTION',
'DB_HOST','DB_PORT','DB_DATABASE','DB_USERNAME','DB_PASSWORD',
'SESSION_LIFETIME','SESSION_ENCRYPT','SESSION_PATH','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET',
'GOOGLE_REDIRECT_URI','PASSPORT_CLIENT_ID','PASSPORT_CLIENT_SECRET','BROADCAST_CONNECTION','FILESYSTEM_DISK',
